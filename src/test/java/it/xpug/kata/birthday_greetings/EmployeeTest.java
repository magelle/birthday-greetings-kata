...
public class EmployeeTest {
	...
	public void testBirthday() throws Exception {
		...
		assertFalse("not his birthday", employee.isBirthday(new AnniversaryDate("2008/01/30")));
		assertTrue("his birthday", employee.isBirthday(new AnniversaryDate("2008/01/31")));
	}
